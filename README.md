...
- :tada:[0-生产问题处理总览](生产线上问题处理/0-生产问题处理总览.md) - 问题分类体系、排查通用流程、常用排查工具、50个案例索引
- :tada:[1-CPU相关问题案例](生产线上问题处理/1-CPU相关问题案例.md) - 案例1-8：正则表达式灾难性回溯、死循环、频繁GC、序列化CPU飙高、锁竞争
- :tada:[2-内存相关问题案例](生产线上问题处理/2-内存相关问题案例.md) - 案例9-16：大List导致OOM、缓存未过期、文件流未关闭、线程泄漏、元空间溢出、堆外内存泄漏
- :tada:[3-磁盘IO相关问题案例](生产线上问题处理/3-磁盘IO相关问题案例.md) - 案例17-22：日志打满磁盘、临时文件未清理、inode耗尽、IO等待、文件句柄泄漏
- :tada:[4-网络连接相关问题案例](生产线上问题处理/4-网络连接相关问题案例.md) - 案例23-28：连接池耗尽、TIME_WAIT过多、CLOSE_WAIT泄漏、端口耗尽、DNS超时
- :tada:[5-数据库相关问题案例](生产线上问题处理/5-数据库相关问题案例.md) - 案例29-36：慢查询、锁等待、连接池耗尽、主从延迟、索引失效、死锁、深度分页
- :tada:[6-JVM相关问题案例](生产线上问题处理/6-JVM相关问题案例.md) - 案例37-42：频繁Full GC、GC停顿过长、类加载冲突、线程死锁、线程池耗尽、栈溢出
- :tada:[7-中间件相关问题案例](生产线上问题处理/7-中间件相关问题案例.md) - 案例43-50：缓存穿透/雪崩/溢出、MQ消息堆积/消费失败、Nginx 502/504、Feign超时

### 快速导航

| 场景 | 推荐文档 | 案例范围 |
|------|---------|---------|
| CPU 飙高 | [CPU相关问题案例](生产线上问题处理/1-CPU相关问题案例.md) | 案例 1-8 |
| 内存溢出 | [内存相关问题案例](生产线上问题处理/2-内存相关问题案例.md) | 案例 9-16 |
| 磁盘问题 | [磁盘IO相关问题案例](生产线上问题处理/3-磁盘IO相关问题案例.md) | 案例 17-22 |
| 网络问题 | [网络连接相关问题案例](生产线上问题处理/4-网络连接相关问题案例.md) | 案例 23-28 |
| 数据库问题 | [数据库相关问题案例](生产线上问题处理/5-数据库相关问题案例.md) | 案例 29-36 |
| JVM 问题 | [JVM相关问题案例](生产线上问题处理/6-JVM相关问题案例.md) | 案例 37-42 |
| 中间件问题 | [中间件相关问题案例](生产线上问题处理/7-中间件相关问题案例.md) | 案例 43-50 |
